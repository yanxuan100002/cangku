...
import com.rainng.coursesystem.service.student.CourseShoppedService;
...
@RestController
public class CourseShoppedController extends BaseController {
    private final CourseShoppedService service;

    public CourseShoppedController(CourseShoppedService service) {
